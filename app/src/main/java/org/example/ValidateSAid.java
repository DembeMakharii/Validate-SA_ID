...
public class ValidateSaId {
    ...
    public static boolean isValidIdNumber(String idNumber) {
        ...
        // Check date validity
        if (!isValidBirthDate(idNumber.substring(0, 6))) {
            return false;
        }
        ...
        // Check citizenship
        if (!isValidCitizenshipStatus(idNumber)) {
    ...
    private static boolean isValidCitizenshipStatus(String idNumber) {
    ...
    private static boolean isValidLuhnChecksum(String idNumber) {
        ...
        if (actualCheckDigit != calculatedCheckDigit) {
            System.out.println("✗ Checksum failed - expected " + calculatedCheckDigit + " but found " + actualCheckDigit);
            return false;
        }
